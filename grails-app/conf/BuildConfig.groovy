...
grails.project.dependency.resolution = {
    ...
    dependencies {
        ...
        /*
            due to http://jira.grails.org/browse/GRAILS-6147 'classifiers' are currently not working in Grails dependencies
            as a workaround, copy the artifact to /lib
         */
        //runtime(group:"org.neo4j.app", name:"neo4j-server", version:"1.6.1", 'classifier':"static-web")
